...
from ddd.logic.learning_unit.domain.service.get_effective_class_warnings import EffectiveClassVolumesWarnings
from ddd.logic.learning_unit.repository.i_effective_class import IEffectiveClassRepository
from ddd.logic.learning_unit.repository.i_learning_unit import ILearningUnitRepository


def get_effective_class_volumes_warnings(
        cmd: 'GetEffectiveClassVolumesWarningsCommand',
    ...
    return EffectiveClassVolumesWarnings.get(effective_class=effective_class, learning_unit=learning_unit)
