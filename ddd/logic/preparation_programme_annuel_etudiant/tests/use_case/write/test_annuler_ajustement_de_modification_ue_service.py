...
class TestAnnulerAjustementDeModificationUE(SimpleTestCase):
    ...
    def setUp(self) -> None:
        ...
        self.ue_modifiee = UniteEnseignementModifiee(entity_id=UniteEnseignementModifieeIdentity(uuid=uuid.uuid4()),
    ...
    def test_should_annuler_ajustement_modification_UE(self):
        ...
        self.message_bus.invoke(
            AnnulerAjustementDeModificationCommand(
                ...
                code_unite_enseignement_uuid=self.ue_modifiee.entity_id
            )
        )
