...
def annuler_ajustement_de_suppression_ue(
        cmd: 'AnnulerAjustementDeSuppressionCommand',
    ...
    groupement_ajuste = repository.search_ue_ajustee_en_suppression(
    ...
    # WHEN
    repository.delete_ajustement_suppression(groupement_ajuste)
