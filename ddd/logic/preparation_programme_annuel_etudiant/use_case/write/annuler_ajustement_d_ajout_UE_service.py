...
def annuler_ajustement_d_ajout_ue(
        cmd: 'AnnulerAjustementDAjoutCommand',
    ...
    groupement_ajuste = repository.search_ue_ajustee_en_ajout(
    ...
    # WHEN
    repository.delete_ajustement_ajout(groupement_ajuste)
