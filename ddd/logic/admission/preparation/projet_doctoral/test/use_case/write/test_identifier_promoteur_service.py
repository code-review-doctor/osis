...
from ddd.logic.admission.preparation.projet_doctoral.commands import IdentifierPromoteurCommand
...
from ddd.logic.admission.preparation.projet_doctoral.domain.validator.exceptions import (
    ...
    PromoteurNonTrouveException, GroupeDeSupervisionNonTrouveException,
)
