# Generated by Django 2.2.13 on 2021-10-18 12:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('educational_transition', models.CharField(blank=True, choices=[('TEACHING_OF_GENERAL_EDUCATION', 'Teaching of general education'), ('TRANSITION_METHOD', 'Transition method'), ('ARTISTIC_TRANSITION', 'Artistic transition')], max_length=50, null=True, verbose_name='Educational transition')),
                ('educational_qualification', models.CharField(blank=True, choices=[('QUALIFICATION_METHOD', 'Qualification method'), ('ARTISTIC_QUALIFICATION', 'Artistic qualification'), ('PROFESSIONAL_EDUCATION', 'Professional education'), ('PROFESSIONAL_EDUCATION_AND_MATURITY_EXAM', 'Professional education + Maturity exam')], max_length=50, null=True, verbose_name='Educational qualification')),
