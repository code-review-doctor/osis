...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'abstract': False,
                'permissions': (('add_training', 'Can add training'), ('add_minitraining', 'Can add mini-training'), ('add_group', 'Can add group'), ('delete_training', 'Can delete training'), ('delete_minitraining', 'Can delete mini-training'), ('delete_group', 'Can delete group'), ('change_commonpedagogyinformation', 'Can change common pedagogy information'), ('change_pedagogyinformation', 'Can change pedagogy information'), ('change_link_data', 'Can change link data')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('education_group_year', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='base.EducationGroupYear')),
            ],
            options={
