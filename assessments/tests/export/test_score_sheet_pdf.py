...
class TestPaperSheet(TestCase):
    def test_valid_data(self):
        data = get_right_data()
        self.assertEqual(data, score_sheet_pdf.validate_data_structure(data))

    def test_data_empty(self):
        with self.assertRaises(voluptuous_error.MultipleInvalid):
            score_sheet_pdf.validate_data_structure({})
    ...
    def test_data_with_wrong_link_to_regulation(self):
        ...
        try:
            score_sheet_pdf.validate_data_structure(data)
    ...
    def test_check_pdf_generation(self):
        data = get_right_data()
        http_response = score_sheet_pdf.build_response(data)
