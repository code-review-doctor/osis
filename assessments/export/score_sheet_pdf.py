...
# TODO: Refactor to improve code - Suggest: Use SAP PDF Generator...
...
def _build_legend_block(decimal_scores):
    ...
    legend_text = str(_('Score legend: A=Absent, T=Cheating, {score} (0=Score of presence)').format(score="0 - 20"))
    if decimal_scores:
