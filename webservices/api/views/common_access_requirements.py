...
from webservices.api.serializers.common_access_requirements import CommonAccessRequirementsSerializer
...
class CommonAccessRequirements(generics.RetrieveAPIView):
    ...
    def get(self, request, *args, **kwargs):
        commons_qs = EducationGroupYear.objects.look_for_common(
            ...
            education_group_type__name__in=general_information_sections.COMMON_TYPE_ACCESS_REQUIREMENTS.keys(),
        ...
        for common in commons_qs:
            relevant_attr = general_information_sections.COMMON_TYPE_ACCESS_REQUIREMENTS[
