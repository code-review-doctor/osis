...
class TestTutorEditEducationalInformation(TestCase):
    ...
    @mock.patch(
        'attribution.views.manage_my_courses.manage_my_courses.edit_learning_unit_pedagogy', return_value=HttpResponse()
    )
...
class TestTutorEditForceMajeurEducationalInformation(TestCase):
    ...
    @mock.patch('attribution.views.manage_my_courses.manage_my_courses.post_method_edit_force_majeure_pedagogy',
