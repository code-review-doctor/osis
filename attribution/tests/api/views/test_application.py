...
class MyChargeSummaryViewTestCase(APITestCase):
    @classmethod
    def setUpTestData(cls):
        cls.tutor = TutorFactory(person__global_id="2656859898")
        cls.url = reverse('attribution_api_v1:' + MyChargeSummaryView.name)
    ...
    def test_post_assert_call_message_bus_invoke_send_applications_summary_command(self):
        ...
        self.assertIsInstance(invoke_args[0], GetChargeSummaryCommand)
