...
class AttributionSerializer(serializers.Serializer):
    ...
    lecturing_charge = serializers.DecimalField(max_digits=6, decimal_places=2)
    practical_charge = serializers.DecimalField(max_digits=6, decimal_places=2)
    total_learning_unit_charge = serializers.DecimalField(max_digits=6, decimal_places=2)
