...
class VacantCourseGetSerializer(serializers.Serializer):
    ...
    lecturing_volume_total = serializers.DecimalField(max_digits=6, decimal_places=2, read_only=True)
    practical_volume_total = serializers.DecimalField(max_digits=6, decimal_places=2, read_only=True)
