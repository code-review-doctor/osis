...
class ApplicationGetSerializer(serializers.Serializer):
    ...
    lecturing_volume = serializers.DecimalField(max_digits=6, decimal_places=2, read_only=True)
    practical_volume = serializers.DecimalField(max_digits=6, decimal_places=2, read_only=True)
    lecturing_volume_available = serializers.DecimalField(max_digits=6, decimal_places=2, read_only=True)
    practical_volume_available = serializers.DecimalField(max_digits=6, decimal_places=2, read_only=True)
...
class ApplicationPostSerializer(serializers.Serializer):
    ...
    lecturing_volume = serializers.DecimalField(max_digits=6, decimal_places=2)
    practical_volume = serializers.DecimalField(max_digits=6, decimal_places=2)
...
class AttributionsAboutToExpireGetSerializer(serializers.Serializer):
    ...
    total_lecturing_volume_course = serializers.DecimalField(max_digits=6, decimal_places=2, read_only=True)
    total_practical_volume_course = serializers.DecimalField(max_digits=6, decimal_places=2, read_only=True)
    lecturing_volume_available = serializers.DecimalField(max_digits=6, decimal_places=2, read_only=True)
    practical_volume_available = serializers.DecimalField(max_digits=6, decimal_places=2, read_only=True)
