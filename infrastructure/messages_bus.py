...
from ddd.logic.learning_unit.commands import CreateLearningUnitCommand, GetLearningUnitCommand, \
    ...
    GetEffectiveClassWarningsCommand, GetEffectiveClassVolumesWarningsCommand
...
from ddd.logic.learning_unit.use_case.read.get_effective_class_volumes_warnings_service import get_effective_class_volumes_warnings
...
class MessageBus:
    command_handlers = {
        ...
        GetEffectiveClassVolumesWarningsCommand: lambda cmd: get_effective_class_volumes_warnings(
            cmd, EffectiveClassRepository(), LearningUnitRepository()
        ),
