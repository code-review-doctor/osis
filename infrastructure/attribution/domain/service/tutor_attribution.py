...
from django.db.models import F, Value, BooleanField, Prefetch, Case, When, Count, CharField
...
class TutorAttributionToLearningUnitTranslator(ITutorAttributionToLearningUnitTranslator):
    ...
    def search_attributions_to_learning_unit(
        ...
        qs = AttributionChargeNew.objects.filter(
            ...
            number_of_assigned_to_class=Count('attributionclass'),
        ).values(
            'learning_unit_code',
            'learning_unit_year',
            'attribution_uuid',
