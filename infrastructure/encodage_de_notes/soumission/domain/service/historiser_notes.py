...
from ddd.logic.encodage_des_notes.soumission.domain.service.i_historiser_notes import IHistoriserNotes
...
class HistoriserNotes(IHistoriserNotes):
    @classmethod
    ...
    @classmethod
    def get_history_identity(cls, code_unite_enseignement: str, annee_academique: int, numero_session: int) -> str:
        return get_history_identity(code_unite_enseignement, annee_academique, numero_session)
