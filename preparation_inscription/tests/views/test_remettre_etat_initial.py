...
class TestRemettreEtatInitialView(TestCase):

    @classmethod
    def setUpTestData(cls):
        cls.url = reverse(
            RemettreEtatInitialView.name,
    ...
    def __mock_service_bus(self):
        message_bus_patcher = mock.patch('infrastructure.messages_bus.remettre_programme_dans_etat_initial')
    ...
    def test_assert_template_used(self):
        response = self.client.get(self.url)
        self.assertTemplateUsed(response, "preparation_inscription/modal_confirmer_remettre_etat_initial_inner.html")
