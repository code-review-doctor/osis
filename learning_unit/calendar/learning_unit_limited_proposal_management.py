...
class LearningUnitLimitedProposalManagementCalendar(AcademicEventCalendarHelper):
    event_reference = academic_calendar_type.LEARNING_UNIT_LIMITED_PROPOSAL_MANAGEMENT
