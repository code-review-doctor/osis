...
class AddLearningUnitFormView(LoginRequiredMixin, HtmxMixin, TemplateView):
    name = 'add_learning_units_view'

    # FormView
    template_name = "mockup/ajouter_unites_enseignement.html"
    htmx_template_name = "mockup/ajouter_unites_enseignement.html"
    ...
    def get_context_data(self, **kwargs):
        return {
            **super().get_context_data(**kwargs),
            ...
            'cancel_url': reverse('EventModelingView')
        }
