...
class ModifierProprietesContenuView(LoginRequiredMixin, HtmxMixin, FormView):
    name = 'modifier-proprietes-contenu'

    # FormView
    template_name = "mockup/modification_unites_enseignement.html"
    htmx_template_name = "mockup/modification_unites_enseignement.html"
