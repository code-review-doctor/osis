...
def postpone_backbone_group_modification_service(
        postpone_cmd: command.UpdateGroupCommand
) -> List['GroupIdentity']:
    print("postpone_backbone_group_modification_service")
    from_year = postpone_cmd.year
