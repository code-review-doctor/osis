...
from .models import group, group_year, first_year_bachelor
...
admin.site.register(first_year_bachelor.FirstYearBachelor, first_year_bachelor.FirstYearBachelorAdmin)
