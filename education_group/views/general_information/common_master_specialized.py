...
class CommonMasterSpecializedAccessRequirements(PermissionRequiredMixin, TemplateView):
    ...
    def get_tab_urls(self):
        return {
            Tab.ACCESS_REQUIREMENTS: {
                ...
                'active': True,
                'display': True,
                'url': reverse('common_master_specialized_access_requirements', kwargs={'year': self.kwargs['year']})
            }
        }
    ...
    def get_publish_url(self):
        return reverse('publish_common_master_specialized_access_requirements', kwargs={'year': self.kwargs['year']})
