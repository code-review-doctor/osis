...
from base.business.education_groups.access_requirements import postpone_access_requirements, \
    can_postpone_access_requirements
...
class UpdateAccessRequirements(SuccessMessageMixin, AccessRequirementsMixin, PermissionRequiredMixin, AjaxTemplateMixin,
                               FormView):
    template_name = "education_group_app/access_requirements/edit.html"
    ...
    def form_valid(self, form):
        ...
        if self.request.POST.get("to_postpone"):
            ...
            postpone_access_requirements(self.object.education_group_year, fields)
