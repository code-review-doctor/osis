...
def get_access_requirements(acronym: str, year: int):
    try:
    ...
    return __format_access_requirements(admission_condition)


def __format_access_requirements(admission_condition):
    access_requirements_formated = __default_access_requirements()
    for key, label in access_requirements_formated.items():
        label['text_fr'] = admission_condition[key + "_fr"]
        label['text_en'] = admission_condition[key + "_en"]
    return access_requirements_formated


def __default_access_requirements():
    return {
...
def get_access_requirements_lines(acronym: str, year: int, language: str):
    access_requirements_sections = (
        'ucl_bachelors',
    ...
    access_requirements_lines = {}
    for section in access_requirements_sections:
        access_requirements_lines[section] = AdmissionConditionLine.objects.filter(
    ...
    return access_requirements_lines


def get_common_access_requirements(offer_type: str, year: int):
    try:
        ...
        return __default_common_access_requirements()
    return __format_common_access_requirements(common_of_same_type)


def __default_common_access_requirements():
    return {
        'alert_message': {
...
def __format_common_access_requirements(common_admission_condition):
    access_requirements_formated = __default_common_access_requirements()
    for key, label in access_requirements_formated.items():
