...
class EducationGroupExtendedDailyManagementCalendar(AcademicEventCalendarHelper):
    event_reference = academic_calendar_type.EDUCATION_GROUP_EXTENDED_DAILY_MANAGEMENT
