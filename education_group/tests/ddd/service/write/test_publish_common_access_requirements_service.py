...
from education_group.ddd.service.write import publish_common_access_requirements_service
...
class TestPublishCommonAccessRequirementsService(TestCase):
    @classmethod
    ...
    def setUp(self):
        ...
        self.get_publish_url_patcher = mock.patch(
            "education_group.ddd.service.write.publish_common_access_requirements_service."
            "GetCommonPublishUrl.get_url_access_requirements",
    ...
    def test_publish_call_external_service(self):
        publish_common_access_requirements_service.publish_common_access_requirements(self.cmd)
