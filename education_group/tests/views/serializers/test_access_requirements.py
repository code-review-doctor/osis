...
class TestGetCommonAccessRequirementsSerializer(TestCase):
    ...
    def test_assert_return_admission_of_pgrm_120_when_offer_type_is_master_60(self):
        self.assertDictEqual(
            access_requirements.get_common_access_requirements(TrainingType.MASTER_M1.name, 2018),
    ...
    def test_assert_return_admission_of_pgrm_120_when_offer_type_is_master_180_240(self):
        self.assertDictEqual(
            access_requirements.get_common_access_requirements(TrainingType.PGRM_MASTER_180_240.name, 2018),
            self.common_training_120_condition_serialized
        )
