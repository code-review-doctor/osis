...
from base.models.admission_condition import AdmissionConditionLine, ACCESS_REQUIREMENTS_ACCESSES, AdmissionCondition
from base.tests.factories.person import SuperUserPersonFactory
from education_group.tests.views.access_requirements.common import TestAccessRequirementsMixin
...
class TestUpdateAccessRequirementsLine(TestCase, TestAccessRequirementsMixin):
    ...
    def setUp(self) -> None:
        ...
        self.en_url = reverse(
            "education_group_year_access_requirements_update_line",
            args=[self.education_group_year.academic_year.year, self.education_group_year.partial_acronym]
    ...
    def generate_fr_post_data(cls, to_postpone=False):
        post_data = {
            "access": ACCESS_REQUIREMENTS_ACCESSES[0][0],
