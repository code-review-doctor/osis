...
class TestTrainingReadAdmissionCondition(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.url = reverse('training_access_requirements', kwargs={'year': 2019, 'code': 'LDROI200M'})

    def setUp(self) -> None:
        self.client.force_login(self.person.user)

        self.perm_patcher = mock.patch(
            "education_group.views.training.access_requirements_read.TrainingReadAccessRequirements."
            "have_access_requirements_tab",
            return_value=True
        )
    ...
    def test_case_training_unauthorized_access_requirements_tab(self):
        with mock.patch(
                "education_group.views.training.access_requirements_read.TrainingReadAccessRequirements."
                "have_access_requirements_tab",
                return_value=False
    ...
    def test_case_training_not_exists(self):
        dummy_url = reverse('training_access_requirements', kwargs={'year': 2018, 'code': 'DUMMY100B'})
    ...
    def test_assert_template_used(self):
        ...
        self.assertTemplateUsed(response, "education_group_app/training/access_requirements_read.html")
    ...
    def test_assert_context_data(self):
        ...
        self.assertIn("common_access_requirements", response.context)
        self.assertIn("access_requirements", response.context)
        ...
        self.assertIn("access_requirements_lines", response.context)

    def test_assert_active_tabs_is_access_requirements_and_others_are_not_active(self):
