...
class TestTrainingReadContent(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.url = reverse('training_content', kwargs={'year': 2019, 'code': 'LDROI200M'})
    ...
    def test_case_training_not_exists(self):
        dummy_url = reverse('training_content', kwargs={'year': 2018, 'code': 'DUMMY100B'})
    ...
    def test_assert_template_used(self):
        ...
        self.assertTemplateUsed(response, "education_group_app/training/content_read.html")
