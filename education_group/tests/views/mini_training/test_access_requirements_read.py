...
class TestMiniTrainingReadAdmissionCondition(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.url = reverse('mini_training_access_requirements', kwargs={
    ...
    def setUp(self) -> None:
        ...
        self.perm_patcher = mock.patch(
            "education_group.views.mini_training.access_requirements_read.MiniTrainingReadAccessRequirements."
    ...
    def test_case_mini_training_unauthorized_access_requirements_tab(self):
        with mock.patch(
                "education_group.views.mini_training.access_requirements_read.MiniTrainingReadAccessRequirements."
                "have_access_requirements_tab",
                return_value=False
    ...
    def test_case_mini_training_not_exists(self):
        dummy_url = reverse('mini_training_access_requirements', kwargs={'year': 2018, 'code': 'DUMMY100B'})
    ...
    def test_assert_template_used(self):
        ...
        self.assertTemplateUsed(response, "education_group_app/mini_training/access_requirements_read.html")
