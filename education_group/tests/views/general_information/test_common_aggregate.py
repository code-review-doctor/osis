...
class TestCommonAggregateAdmissionCondition(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.url = reverse('common_aggregate_access_requirements', kwargs={'year': 2018})
    ...
    def test_case_common_and_admission_condition_not_exists(self):
        dummy_url = reverse('common_aggregate_access_requirements', kwargs={'year': 1990})
        response = self.client.get(dummy_url)

        self.assertEqual(response.status_code, HttpResponseNotFound.status_code)

    def test_case_common_exist_but_admission_condition_not_exist(self):
        obj = EducationGroupYearCommonAgregationFactory(academic_year__year=1990)
    ...
    def test_assert_context_data(self):
        ...
        expected_publish_url = reverse('publish_common_aggregate_access_requirements', kwargs={
